...
import * as flags from "./flags/flagsIndex";
...
export default class PhoneInput extends PureComponent<PhoneInputProps, PhoneInputState> {
  ...
  render(): JSX.Element {
    ...
    const { modalVisible, code, countryCode, number, disabled, searchText, label } = this.state;
                  ...
                  <View style={{
                    ...
                    <TextInput
                      style={{
                        ...
                        paddingVertical: 8,
                        borderWidth: 1,
                        borderColor: mergedTheme.inputBorderColor,
                      }}
